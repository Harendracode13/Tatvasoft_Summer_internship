...
values('Shubha','piprotar','shubh7@gmail.com',Now(),Null,true);

-- select * from customer

-- Insert multiple records
insert into customer (first_name,last_name,email,created_date,updated_date,active)
values('Harendra','piprotar','harendrapiprotar@gmail.com',Now(),Null,true),
('Rakesh','solanki','rakeshsolnaki@gmail.com',Now(),Null,true),
('Raj','Prajapati','raj123@gmail.com',Now(),Null,true),
('Mohan','Kanet','kanetmohan@gmail.com',Now(),Null,true);
...
select first_name,last_name from customer where first_name = 'Rakesh';
select customer_id , first_name,last_name from customer where first_name = 'Harendra';
SELECT customer_id, first_name, last_name FROM customer WHERE first_name IN ('John', 'Daud', 'Mohan');
...
-- Update Statement
UPDATE customer
SET first_name = 'Prince', last_name = 'karena', email = 'karenaprince45@tatvasoft.com'
WHERE customer_id = 3;
